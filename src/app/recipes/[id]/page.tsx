    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-50 px-4 py-4">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center space-x-2">
          <Link href={`/recipe/${id}/collaborate`}>
            <Button variant="outline" size="sm" className="h-8 px-3 rounded-full bg-white border-gray-200">
      ...
      <Card className="bg-white rounded-xl shadow-sm overflow-hidden mb-4">
        <div className="relative">
          <img src="/images/generated-croissant.png" alt="Recipe" className="w-full h-48 object-cover" />
      ...
      {/* Author and Collaborators - Enhanced */}
        ...
        <CardContent className="p-4">
          <div className="flex items-center justify-between mb-3">
            ...
            <Button
              ...
              className="text-xs"
            >
              {showCollaborators ? "Hide Collaboration" : "Manage Collaboration"}
            </Button>
          </div>

          {/* Original Curator - Always Visible */}
          <div className="bg-orange-50 rounded-lg p-3 mb-3">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-xs text-orange-600 font-medium">🏆 Original Curator</p>
              </div>
            </div>
          </div>
            ...
            <div className="mb-3">
              ...
              <div className="grid grid-cols-2 gap-2">
                {recipe.collaborators.map((collaborator, index) => (
                  <div key={index} className="flex items-center bg-gray-50 rounded-lg px-2 py-2">
          ...
          {showCollaborators && (
            <>
              <div className="border-t border-gray-100 pt-3 mb-3">
                <h3 className="text-sm font-medium mb-2">Collaboration Features</h3>
                <div className="bg-blue-50 rounded-lg p-3 mb-3">
                  <p className="text-xs text-blue-800">
                    <strong>How Collaboration Works:</strong>
                    <br />• Original curator gets permanent credit
                    <br />• Collaborators can edit ingredients & steps
                    <br />• All changes are tracked
                    <br />• Recipe remains attributed to original creator
                  </p>
                </div>
              </div>

              <div className="border-t border-gray-100 pt-3">
                <p className="text-xs text-gray-500 mb-2">Invite New Collaborator:</p>
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 text-xs px-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500"
                  />
                  <Button
                    size="sm"
                ...
                {/* Pending Invitations */}
                <div className="mt-3">
                  <p className="text-xs text-gray-500 mb-1">Pending Invitations:</p>
                  <div className="space-y-1">
                    <div className="flex items-center justify-between bg-yellow-50 rounded px-2 py-1">
                      <span className="text-xs">chef.marie@example.com</span>
                      <Badge variant="outline" className="text-xs">
                        Pending
                      </Badge>
                    </div>
                    <div className="flex items-center justify-between bg-yellow-50 rounded px-2 py-1">
                      <span className="text-xs">baker.john@example.com</span>
                      <Badge variant="outline" className="text-xs">
                        Pending
                      </Badge>
                    </div>
